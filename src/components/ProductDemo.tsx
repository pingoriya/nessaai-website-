      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          {tabs.map((tab, index) => {
            ...
            return (
              <button
                ...
                onClick={() => {
                  setActiveTab(index);
                  setIsPlaying(false); // reset video when switching tabs
                }}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            {isPlaying ? (
              <div className="rounded-3xl overflow-hidden aspect-video border-2 border-blue-300 shadow-2xl">
                <iframe
                  src="https://player.vimeo.com/video/1116707298?autoplay=1&title=0&byline=0&portrait=0"
                  width="100%"
                  height="100%"
              ...
              <div
                className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl aspect-video flex items-center justify-center group cursor-pointer hover:shadow-2xl transition-all duration-300 border-2 border-gray-200 hover:border-blue-300"
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-4xl font-bold text-gray-900 mb-6">{tabs[activeTab].title}</h3>
              <p className="text-xl text-gray-600 leading-relaxed">{tabs[activeTab].description}</p>
            </div>
